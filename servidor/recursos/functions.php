...
$HOST  = "http://".$_SERVER['HTTP_HOST'].'/servidor/';	//."/".@$_SERVER['REQUEST_URI']; //RUTA especifica


$HOST2 = "http://".$_SERVER['HTTP_HOST'].''.$_SERVER['REQUEST_URI'];
$HOST3 =$_SERVER['HTTP_REFERER'];
...
function leer_feed($q){		
		...
		$vid[$i]=array(
				 ...
				 'pag_video' 	=> 'ver/'.getIde($url[$i]).'/'.$url_amigable.'.html',
